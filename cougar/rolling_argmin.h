#ifndef __ROLLING_ARGMIN_H__
#define __ROLLING_ARGMIN_H__
...
static void rolling_argmin_float64(PyArrayObject* input, PyArrayObject* output, int window, int min_count, int axis) {
...
PyObject* rolling_argmin(PyObject* self, PyObject* args, PyObject* kwargs) {
    ...
    if (dtype == NPY_FLOAT64) {
        rolling_argmin_float64(arr, argmin, window, min_count, axis);
    }
    // else if (dtype == NPY_FLOAT32) {
    //     rolling_argmin_float32(arr, argmin, window, min_count, axis);
    // } else if (dtype == NPY_INT64) {
    //     rolling_argmin_int64(arr, argmin, window, min_count, axis);
    // }
    // else if (dtype == NPY_INT32) {
    //     rolling_argmin_int32(arr, argmin, window, min_count, axis);
    // }
    // else if (dtype == NPY_BOOL) {
    //     rolling_argmin_bool(arr, argmin, window, min_count, axis);
    // }
    else {
