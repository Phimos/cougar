...
#define Rolling_Compute() ((TargetType)(i - monotonic_queue_method(front_index, SourceType)(queue)))
...
PyObject* rolling_argmin(PyObject* self, PyObject* args, PyObject* kwargs) {
    ...
    if (dtype == NPY_FLOAT64) {
        rolling_argmin_npy_float64(arr, argmin, window, min_count, axis);
    } else if (dtype == NPY_FLOAT32) {
        rolling_argmin_npy_float32(arr, argmin, window, min_count, axis);
    } else if (dtype == NPY_INT64) {
        rolling_argmin_npy_int64(arr, argmin, window, min_count, axis);
    } else if (dtype == NPY_INT32) {
        rolling_argmin_npy_int32(arr, argmin, window, min_count, axis);
    } else {
